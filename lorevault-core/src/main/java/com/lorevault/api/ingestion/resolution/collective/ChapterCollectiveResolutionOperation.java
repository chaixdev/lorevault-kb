 ...
 */
public interface ChapterCollectiveResolutionOperation extends StageOperation {
    ...
    default StepResult execute(UUID jobId, UUID chapterId) {
        return execute(new DispatchContext(jobId, chapterId, null, StageKey.CHAPTER_COLLECTIVE_RESOLUTION));
    }
}
