 ...
 */
public interface ChapterObjectResolutionOperation extends StageOperation {
    ...
    default StepResult execute(UUID jobId, UUID chapterId) {
        return execute(new DispatchContext(jobId, chapterId, null, StageKey.CHAPTER_OBJECT_RESOLUTION));
    }
}
