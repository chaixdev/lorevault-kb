...
public class IngestionJobService {
    ...
    private IngestionStatus mapStageKeyToIngestionStatus(StageKey key) {
        return switch (key) {
            ...
            case CHAPTER_INDIVIDUAL_RESOLUTION, BOOK_INDIVIDUAL_REDUCTION -> IngestionStatus.RESOLVING_INDIVIDUALS;
            case CHAPTER_COLLECTIVE_RESOLUTION, BOOK_COLLECTIVE_REDUCTION -> IngestionStatus.RESOLVING_COLLECTIVES;
            case CHAPTER_LOCATION_RESOLUTION, BOOK_LOCATION_REDUCTION -> IngestionStatus.RESOLVING_LOCATIONS;
            case CHAPTER_OBJECT_RESOLUTION, BOOK_OBJECT_REDUCTION -> IngestionStatus.RESOLVING_OBJECTS;
            case CHAPTER_EVENT_RESOLUTION -> IngestionStatus.EVENT_COREF;
