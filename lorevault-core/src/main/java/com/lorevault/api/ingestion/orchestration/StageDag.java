 ...
 *   ├── TRIGGERS → CHUNKING
 *   ├── TRIGGERS → CHAPTER_INDIVIDUAL_RESOLUTION
 *   ├── TRIGGERS → CHAPTER_COLLECTIVE_RESOLUTION
 *   ├── TRIGGERS → CHAPTER_LOCATION_RESOLUTION
 *   ├── TRIGGERS → CHAPTER_OBJECT_RESOLUTION
 *   └── TRIGGERS → CHAPTER_EVENT_RESOLUTION
 *
 * CHUNKING → EMBEDDING
 *
 * CHAPTER_INDIVIDUAL_RESOLUTION → BOOK_INDIVIDUAL_REDUCTION
 * CHAPTER_COLLECTIVE_RESOLUTION → BOOK_COLLECTIVE_REDUCTION
 * CHAPTER_LOCATION_RESOLUTION   → BOOK_LOCATION_REDUCTION
 * CHAPTER_OBJECT_RESOLUTION     → BOOK_OBJECT_REDUCTION
 * CHAPTER_EVENT_RESOLUTION      → CHAPTER_EVENT_EMBEDDING
 *
 * CHAPTER_EVENT_EMBEDDING       → BOOK_EVENT_CANDIDATE_GENERATION
 *
 * EMBEDDING                    → INGESTION_COMPLETE
 * BOOK_INDIVIDUAL_REDUCTION    → INGESTION_COMPLETE
 * BOOK_COLLECTIVE_REDUCTION    → INGESTION_COMPLETE
 * BOOK_LOCATION_REDUCTION      → INGESTION_COMPLETE
 * BOOK_OBJECT_REDUCTION        → INGESTION_COMPLETE
...
public final class StageDag {
    ...
    public StageDag() {
        ...
        c.put(StageKey.CHAPTER_INDIVIDUAL_RESOLUTION, List.of(StageKey.BOOK_INDIVIDUAL_REDUCTION));
        c.put(StageKey.CHAPTER_COLLECTIVE_RESOLUTION,  List.of(StageKey.BOOK_COLLECTIVE_REDUCTION));
        c.put(StageKey.CHAPTER_LOCATION_RESOLUTION,    List.of(StageKey.BOOK_LOCATION_REDUCTION));
        c.put(StageKey.CHAPTER_OBJECT_RESOLUTION,      List.of(StageKey.BOOK_OBJECT_REDUCTION));

        // Event lane
        c.put(StageKey.CHAPTER_EVENT_RESOLUTION,    List.of(StageKey.CHAPTER_EVENT_EMBEDDING));
        ...
        c.put(StageKey.BOOK_INDIVIDUAL_REDUCTION,      List.of(StageKey.INGESTION_COMPLETE));
        c.put(StageKey.BOOK_COLLECTIVE_REDUCTION,      List.of(StageKey.INGESTION_COMPLETE));
        c.put(StageKey.BOOK_LOCATION_REDUCTION,        List.of(StageKey.INGESTION_COMPLETE));
        c.put(StageKey.BOOK_OBJECT_REDUCTION,          List.of(StageKey.INGESTION_COMPLETE));
