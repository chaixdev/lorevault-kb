 ...
 *
 * <p>Implemented by {@link BookObjectConsolidationHandler} so that the step-by-step execution controller
 ...
 */
public interface BookObjectConsolidationOperation extends StageOperation {
    ...
    default StepResult execute(UUID jobId, UUID bookId) {
        return execute(new StageExecutionContext(null, jobId, null, bookId, StageKey.BOOK_OBJECT_CONSOLIDATION));
    }
}
