...
public class BookConceptConsolidationHandler implements StageOperation {
    ...
    public StageResult execute(StageExecutionContext ctx) {
        ...
        if (!bookConsolidationClaimService.tryAcquireClaim(bookId, CLAIM_LANE, ctx.stageId())) {
            ...
            log.warn("[BOOK_CONCEPT_CONSOLIDATION] Claim contention: jobId={}, bookId={}", jobId, bookId);
            return StageResult.retryableFailure(StageKey.BOOK_CONCEPT_CONSOLIDATION,
        ...
        try {
            ...
            if (response.success()) {
                ...
                return StageResult.success(StageKey.BOOK_CONCEPT_CONSOLIDATION,
            ...
            return retryable
                    ? StageResult.retryableFailure(StageKey.BOOK_CONCEPT_CONSOLIDATION,
                            sanitize(e), elapsed)
                    : StageResult.failure(StageKey.BOOK_CONCEPT_CONSOLIDATION,
                            sanitize(e), elapsed);
        } finally {
