 ...
 *
 * <p>Implemented by {@link BookCollectiveConsolidationHandler} so that the step-by-step execution controller
 ...
 */
public interface BookCollectiveConsolidationOperation extends StageOperation {
    ...
    default StepResult execute(UUID jobId, UUID bookId) {
        return execute(new StageExecutionContext(null, jobId, null, bookId, StageKey.BOOK_COLLECTIVE_CONSOLIDATION));
    }
}
