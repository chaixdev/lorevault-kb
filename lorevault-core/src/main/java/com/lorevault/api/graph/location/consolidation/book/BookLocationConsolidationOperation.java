 ...
 *
 * <p>Implemented by {@link BookLocationConsolidationHandler} so that the step-by-step execution controller
 ...
 */
public interface BookLocationConsolidationOperation extends StageOperation {
    ...
    default StepResult execute(UUID jobId, UUID bookId) {
        return execute(new StageExecutionContext(null, jobId, null, bookId, StageKey.BOOK_LOCATION_CONSOLIDATION));
    }
}
