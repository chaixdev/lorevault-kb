 ...
 *   ├── TRIGGERS → CHAPTER_CONCEPT_CONSOLIDATION
 ...
 * CHAPTER_CONCEPT_CONSOLIDATION    → BOOK_CONCEPT_CONSOLIDATION
 ...
 * BOOK_CONCEPT_CONSOLIDATION        → INGESTION_COMPLETE
...
public final class StageDag {
    ...
    public StageDag() {
        ...
        c.put(StageKey.CHAPTER_CONCEPT_CONSOLIDATION, List.of(StageKey.BOOK_CONCEPT_CONSOLIDATION));
        ...
        c.put(StageKey.BOOK_CONCEPT_CONSOLIDATION,         List.of(StageKey.INGESTION_COMPLETE));
