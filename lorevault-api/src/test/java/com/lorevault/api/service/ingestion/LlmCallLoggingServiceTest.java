...
class LlmCallLoggingServiceTest {
    ...
    void setUp() {
        ...
        service = new LlmCallLoggingService(props, contentPersistencePort);
    }
    ...
    void logCall_withValidJobId_shouldPersistRecord() {
        ...
        when(contentPersistencePort.findJob(jobId)).thenReturn(Optional.of(job));
        when(contentPersistencePort.addLlmCallRecord(any())).thenAnswer(invocation -> invocation.getArgument(0));
        ...
        verify(contentPersistencePort).addLlmCallRecord(any(LlmCallRecord.class));
    }
    ...
    void logCall_withNullJobId_shouldSkipPersistence() {
        ...
        verifyNoInteractions(contentPersistencePort);
    }
    ...
    void logCall_withDisabledLogging_shouldSkipPersistence() {
        ...
        service = new LlmCallLoggingService(disabledProps, contentPersistencePort);
    ...
    void logCall_withBodiesDisabled_shouldOmitResponseBody() {
        ...
        service = new LlmCallLoggingService(noBodiesProps, contentPersistencePort);
    ...
    void logCall_withRenderedPromptDisabled_shouldOmitRenderedPrompt() {
        ...
        service = new LlmCallLoggingService(noPromptProps, contentPersistencePort);
    ...
    void logCall_withTruncation_shouldTruncateAndSetFlag() {
        ...
        service = new LlmCallLoggingService(truncationProps, contentPersistencePort);
