...
class BookLocationReductionServiceTest {
    ...
    void rebuildsBookLocationsFromChapterLocations() {
        ...
        BookLocationResolutionResponse response = service.resolveBook(bookId);

        assertThat(response.isProcessed()).isTrue();
        assertThat(response.getChapterLocationCount()).isEqualTo(4);
        assertThat(response.getBookLocationCount()).isEqualTo(2);
    ...
    void skipsRebuildWhenNoResolvableChapterLocationsExist() {
        ...
        assertThat(response.getBookLocationCount()).isZero();
