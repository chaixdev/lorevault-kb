...
public class ClasspathPromptRepository implements PromptRepository {
    ...
    public String get(String name) {
        return cache.getOrLoad(name, () -> loadFromClasspath(locationResolver.resolve(name)));
    }
}
...
**Rollback Plan**: Keep the repository behind an interface; you can revert adapters to previous service while retaining the interface.
