...
2. For cross-field or domain-specific rules, move logic into a domain-level validator utility (not a Spring service)
...
**Rollback Plan**: Easy to extract validation back into service if needed for testing isolation.