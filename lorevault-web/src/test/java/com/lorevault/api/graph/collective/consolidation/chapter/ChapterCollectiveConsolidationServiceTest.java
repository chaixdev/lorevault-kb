...
@DisplayName("ChapterCollectiveConsolidationService")
class ChapterCollectiveConsolidationServiceTest {
    ...
    void checksWhetherChapterExists() {
        ...
        when(chapterGraphRepository.findById(chapterId)).thenReturn(Optional.of(new Chapter()));
    ...
    void groupsCollectiveMentionsByNormalizedNameOnly() {
        ...
        verify(chapterCollectiveRepository).linkMentionsToChapterCollective(
                ...
                eq(bridgeFour.id()),
                eq(ChapterCollectiveConsolidationService.CHAPTER_CONSOLIDATED)
        );
        verify(chapterCollectiveRepository).linkMentionsToChapterCollective(
                List.of(councilId),
                kholinCouncil.id(),
                ChapterCollectiveConsolidationService.CHAPTER_CONSOLIDATED
        );
    }
