...
@Testcontainers
@Tag("integration")
class Neo4jSchemaInitializerChapterObjectIndexesIT {
    ...
    @Test
    void ensuresChapterObjectConstraintsAndIndex() {
        assertDoesNotThrow(() -> schemaInitializer.ensureMinimalSchema());

        assertThat(constraintExists("chapter_object_id_unique")).isTrue();
        assertThat(constraintExists("chapter_object_scope_unique")).isTrue();
        assertThat(indexExists("chapter_object_chapter_name")).isTrue();
    }
