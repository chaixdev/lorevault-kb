...
@Testcontainers
@Tag("integration")
class Neo4jSchemaInitializerChapterCollectiveIndexesIT {
    ...
    @Test
    void ensuresChapterCollectiveConstraintsAndIndex() {
        assertDoesNotThrow(() -> schemaInitializer.ensureMinimalSchema());

        assertThat(constraintExists("chapter_collective_id_unique")).isTrue();
        assertThat(constraintExists("chapter_collective_scope_unique")).isTrue();
        assertThat(indexExists("chapter_collective_chapter_name")).isTrue();
    }
