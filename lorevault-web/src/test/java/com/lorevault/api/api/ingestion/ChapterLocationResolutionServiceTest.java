...
class ChapterLocationResolutionServiceTest {
    ...
    void mergesMentionsThroughExactNamesAndAliasBridges() {
        ...
        ChapterLocationResolutionResponse response = service.resolveChapter(chapterId);

        assertThat(response.isProcessed()).isTrue();
        assertThat(response.getMentionCount()).isEqualTo(4);
        assertThat(response.getChapterLocationCount()).isEqualTo(2);
    ...
    void skipsSaveWhenNoResolvableMentionsExist() {
        ...
        assertThat(response.getMentionCount()).isEqualTo(1);
        assertThat(response.getChapterLocationCount()).isZero();
