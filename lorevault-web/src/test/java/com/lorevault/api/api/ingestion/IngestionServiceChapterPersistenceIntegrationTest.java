...
class IngestionServiceChapterPersistenceIntegrationTest {
    ...
    void submitChapter_shouldPersistPublicationScalarsOnCreatedChapter() {
        ...
        SubmitChapterRequest request = createRequest(book);
        ...
        Map<String, Object> persisted = loadChapterProperties(response.getChapterId());
    ...
    private SubmitChapterRequest createRequest(Book book) {
        ...
        request.setChapterText("Kevin Jenkins wakes up on an alien world.");
        return request;
    }
