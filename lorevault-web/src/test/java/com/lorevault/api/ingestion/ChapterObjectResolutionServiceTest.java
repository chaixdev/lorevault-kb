...
@DisplayName("ChapterObjectResolutionService")
class ChapterObjectResolutionServiceTest {
    ...
    @InjectMocks
    private ChapterObjectResolutionService service;
    ...
    void groupsObjectMentionsByNormalizedNameOnly() {
        ...
        verify(chapterObjectRepository).linkMentionsToChapterObject(List.of(doorId), doorCluster.id(), ChapterObjectResolutionService.CHAPTER_RESOLVED);
    }
