...
class StageDispatcherWiringTest {
    ...
    private static final List<Class<? extends StageOperation>> HANDLER_CLASSES = List.of(
            ...
            // Chapter resolution
            com.lorevault.api.ingestion.resolution.individual.ChapterIndividualConsolidationHandler.class,
            com.lorevault.api.ingestion.resolution.collective.ChapterCollectiveConsolidationHandler.class,
            com.lorevault.api.ingestion.resolution.location.ChapterLocationConsolidationHandler.class,
            com.lorevault.api.ingestion.resolution.object.ChapterObjectConsolidationHandler.class,
            // Chapter event
            com.lorevault.api.ingestion.resolution.event.ChapterEventConsolidationHandler.class,
            com.lorevault.api.ingestion.resolution.event.ChapterEventEmbeddingHandler.class,
            // Book reduction
            com.lorevault.api.ingestion.resolution.individual.BookIndividualConsolidationHandler.class,
            com.lorevault.api.ingestion.resolution.collective.BookCollectiveConsolidationHandler.class,
            com.lorevault.api.ingestion.resolution.location.BookLocationConsolidationHandler.class,
            com.lorevault.api.ingestion.resolution.object.BookObjectConsolidationHandler.class,
            // Book event
