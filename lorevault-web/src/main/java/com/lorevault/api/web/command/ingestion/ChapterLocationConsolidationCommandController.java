...
import com.lorevault.api.ingestion.resolution.location.ChapterLocationConsolidationOperation;
...
public class ChapterLocationConsolidationCommandController {
    ...
    public ResponseEntity<?> consolidateChapterLocations(
        ...
        if (fireEvents && result.success()) {
            ...
            stepEventMapper.publishCompletionEvent(StepKey.CHAPTER_CONSOLIDATE_LOCATIONS, jobUuid, chapterUuid, result);
        }
