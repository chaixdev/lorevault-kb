...
import com.lorevault.api.graph.collective.consolidation.book.BookCollectiveConsolidationOperation;
...
public class BookCollectiveConsolidationCommandController {
    ...
    private final BookCollectiveConsolidationOperation bookCollectiveReductionOperation;
    ...
    public ResponseEntity<?> consolidateBookCollectives(
        ...
        StepExecutionResponse response = StepExecutionResponse.from(result, StepKey.BOOK_CONSOLIDATE_COLLECTIVES, "book", bookId);
        ...
        if (fireEvents && result.success()) {
            ...
            stepEventMapper.publishCompletionEvent(StepKey.BOOK_CONSOLIDATE_COLLECTIVES, jobUuid, bookUuid, result);
        }
