...
public class CatalogConfig {
    ...
    @Bean
    public NamedParameterJdbcTemplate catalogNamedParameterJdbcTemplate(DataSource catalogDataSource) {
        return new NamedParameterJdbcTemplate(new JdbcTemplate(catalogDataSource));
    }
